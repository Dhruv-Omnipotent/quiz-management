...
public  String rollNo;
    ...
    private void initComponents() {
        ...
        jTextArea1.setFont(new java.awt.Font("Yu Gothic Medium", 1, 36)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("\t\t1)This quiz consists of 10 questions.\n\n\t\t2)Each question has a strict 1-minute time limit.\n\n\t\t3)You cannot pause or stop the timer, it will run continuously.\n\n\t\t4)Answer each question promptly within the time limit.\n\n\t\t5)Be prepared and stay focused throughout the quiz.\n\n\t\t                               ALL THE BEST !!");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 1920, 670));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 980, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/page background student_1.jpg"))); // NOI18N
